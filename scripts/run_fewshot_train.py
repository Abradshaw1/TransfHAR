"""Stage B fewshot probe training entrypoint."""
...
from imu_lm.probe import fewshot_train_run
...
def _log_resolved(cfg: Dict[str, Any], run_dir: str):
    ...
    with open(log_path, "a") as f:
        f.write("# Resolved config (fewshot probe)\n")
...
def main():
    ...
    # Minimal wandb init for fewshot probe
    ...
    fewshot_train_run.main(cfg, run_dir)
